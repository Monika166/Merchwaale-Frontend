...
const Navbar: React.FC<NavbarProps> = ({ theme, toggleTheme }) => {
  ...
  return (
    <header className="sticky top-0 z-50 bg-white/80 dark:bg-[#101622]/90 backdrop-blur-md border-b border-[#e7ebf3] dark:border-gray-800 px-4 lg:px-10 py-3 min-h-[64px] flex items-center">
        ...
        {isSearchOpen ? (
          <div className="absolute inset-0 z-50 bg-white dark:bg-[#101622] flex items-center px-4 animate-in fade-in slide-in-from-top-4 duration-200">
            ...
            <div className="flex-1 relative ml-2">
              <Search className="absolute left-3 top-1/2 -translate-y-1/2 size-5 text-text-sub" />
              <input
                autoFocus
                className="w-full pl-10 pr-4 py-2.5 bg-[#e7ebf3] dark:bg-gray-800 border-none rounded-xl text-sm focus:ring-2 focus:ring-primary/20 placeholder:text-text-sub dark:text-white"
          ...
          <>
            <div className="flex items-center gap-8">
              <Link to="/" className="flex items-center gap-3 text-primary">
                ...
                <h2 className="text-[#0d121b] dark:text-white text-xl font-bold tracking-tight hidden sm:block">
                  Merchwaale
                </h2>
              </Link>
            ...
            <div className="flex flex-1 justify-center max-w-md px-4 hidden md:flex">
              <div className="relative w-full group">
                <Search className="absolute left-3 top-1/2 -translate-y-1/2 size-5 text-text-sub group-focus-within:text-primary" />
                <input
                  className="w-full pl-10 pr-4 py-2.5 bg-[#e7ebf3] dark:bg-gray-800 border-none rounded-xl text-sm focus:ring-2 focus:ring-primary/20 placeholder:text-text-sub dark:text-white"
