  ...
  return (
    <footer className="bg-white dark:bg-card-dark border-t border-gray-200 dark:border-gray-800 py-16 mt-auto">
      <div className="max-w-[1440px] mx-auto px-4 lg:px-10 grid grid-cols-1 md:grid-cols-4 gap-12">
        <div className="space-y-6">
          ...
          <p className="text-text-sub dark:text-gray-400 text-sm leading-relaxed">
            Designed exclusively for the NIT Patna Campus. Premium quality
            student-friendly prices. Supporting your college journey from day
            one to convocation.
          </p>
          <div className="flex gap-4">
            <a
              href="#"
              className="p-2 rounded-lg bg-gray-50 dark:bg-gray-800 text-text-sub hover:text-primary transition-colors"
            >
              <Instagram size={20} />
            </a>
            <a
        ...
        <div>
          <h4 className="font-black text-text-main dark:text-white mb-6 uppercase tracking-wider text-sm">
            Shop
          </h4>
      ...
      <div className="max-w-[1440px] mx-auto px-4 lg:px-10 mt-16 pt-8 border-t border-gray-100 dark:border-gray-800 text-center text-xs text-text-sub dark:text-gray-500">
        <p>
          © 2026 Merchwaale. Designed exclusively for NIT Patna Campus. All
          rights reserved.
        </p>
      </div>
    </footer>
